...
/* Обновление для обеспечения корректной работы контролов масштабирования */
...
.list-item:hover .remove-list-item {
  opacity: 1;
}
...
.custom-map-marker div {
  ...
  /* Добавляем явное отображение маркера */
  display: block;
  opacity: 1;
  pointer-events: auto;
}
...
/* Стиль для маркера и всплывающей подсказки */
.custom-map-marker {
  cursor: pointer;
  z-index: 900;
}
